                        ...
                        <div className="container-fluid clearfix inner-bar">
                            ...
                            <div className={`header-nav w3menu w3menu-end mo-left ${show === 2 ? 'show' : ''}`} id="W3Menu">
                                ...
                                <div className="dz-social-icon">
                                    <ul>
                                        <li> <Link href="https://www.facebook.com/joyboy.ae" target="_blank"> <i className="fa-brands fa-facebook-f" /> </Link> </li>
                                        <li> <Link href="https://x.com/joyboy_ae" target="_blank"> <i className="fa-brands fa-x-twitter" /> </Link> </li>
                                        <li> <Link href="https://www.linkedin.com/company/101417459" target="_blank"> <i className="fa-brands fa-linkedin" /> </Link> </li>
                                        <li> <Link href="https://www.instagram.com/joyboy_ae_/" target="_blank"> <i className="fa-brands fa-instagram" /> </Link> </li>
                                    </ul>
                                </div>
                            </div>
                ...
                <div className={`offcanvas dz-offcanvas offcanvas offcanvas-end ${show === 1 ? 'show' : ''}`} tabIndex={-1} id="headerSidebar">
                    ...
                    <div className="offcanvas-body">
                        <div className="widget">
                            ...
                            <p>DrBuddies is a modern and responsive Bootstrap HTML template designed for health and medical websites. Ideal for clinics, hospitals, and healthcare professionals seeking a professional online presence with an elegant and user-friendly design.</p>
                        </div>
                        <div className="widget">
                            ...
                            <ul className="list-check">
                                <li>Revathy Arcade, Chalappuram, Calicut-673002, Kerala, India</li>
                                <li><Link href="mailto:admin@drbuddies.com" className="text-body">admin@drbuddies.com</Link></li>
                                <li><Link href="tel:+11234567890" className="text-body">+91 97473 06060</Link></li>
                            </ul>
                        </div>
                        <div className="widget">
                            <div className="widget-title">
