                    ...
                    <div className="dz-coming-bx">
                        <div className="top-wrapper">
                            ...
                            <div className="dz-content">
                                ...
                                <p>Big things are coming! DrBuddies will be opening its doors soon. Be the first to experience something special!</p>
                        ...
                        <div className="bottom-wrapper">
                            <div className="dz-social-icon style-4 m-b20">
                                <ul>
                                    ...
                                    <li><Link href="https://x.com/joyboy_ae" target="_blank"><i className="fa-brands fa-twitter" /></Link></li>
                            ...
                            <p className="copyright-text m-0">© <span className="current-year">2026</span> <Link href="https://www.joyboy.ae/">JoyBoy.ae</Link>. All Rights Reserved.</p>
                        </div>
                    </div>
                </div>
                <div className="col-xxl-6 col-xl-6 col-lg-6 px-0">
