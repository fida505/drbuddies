                                    ...
                                    <div className="widget widget_info bg-light wow fadeInUp" data-wow-delay="0.3s" data-wow-duration="0.7s">
                                        <div className="icon-bx-wraper style-1 m-b20">
                                            ...
                                            <div className="icon-content">
                                                ...
                                                <p className="fw-normal">Revathy Arcade, Chalappuram, Calicut-673002, Kerala, India</p>
                                            </div>
                                        </div>
                                        <div className="icon-bx-wraper style-1 m-b20">
                                            <div className="icon-bx bg-primary">
                                            ...
                                            <div className="icon-content">
                                                ...
                                                <p className="fw-normal"><Link href="tel:+11234567890" className="text-body">+91 97473 06060</Link></p>
                                            </div>
                                        </div>
                                        <div className="icon-bx-wraper style-1 m-b15">
                                            ...
                                            <div className="icon-content">
                                                ...
                                                <p className="fw-normal"><Link href="mailto:admin@drbuddies.com" className="text-body">admin@drbuddies.com</Link></p>
                                            </div>
                                        </div>
                                    </div>
                                </aside>
