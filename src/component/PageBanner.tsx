        ...
        <>
            <div className="dz-bnr-inr dz-banner-dark overlay-secondary-middle dz-bnr-inr-md" style={{ backgroundImage: `url(${bnrimage})` }}>
                    ...
                    <div className="dz-bnr-inr-entry d-table-cell">
                        ...
                        <div className="dz-btn">
                            <Link href="tel:+11234567890" className="btn btn-lg btn-icon btn-primary radius-xl btn-shadow mb-3 mb-sm-0">
                                <span className="left-icon"> <i className="feather icon-phone-call" /> </span> +91 97473 06060
                            </Link>
                        </div>
                    </div>
                </div>
                ...
                <ul className="dz-social">
                    <li><Link href="https://www.instagram.com/joyboy_ae_/" target="_blank"> 
                            <i className="fa-brands fa-instagram" />
                        </Link>
                    </li>
                    <li><Link href="https://www.facebook.com/joyboy.ae" target="_blank"> 
                            <i className="fa-brands fa-facebook-f" />
                        </Link>
                    </li>
                    <li><Link href="https://x.com/joyboy_ae" target="_blank"> 
