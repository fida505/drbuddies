...
export const serviceboxdata = [
    { id: 1, delay: '0.1s', title: 'Diabetology', description: 'Dr. Iyad Muhammad P', iconClass: 'fa-solid fa-syringe', svg2: SVGICONS.iconbg4 },
    { id: 2, delay: '0.2s', title: 'ENT', description: 'Dr. Nusfan TT', iconClass: 'fa-solid fa-ear-listen', svg2: SVGICONS.iconbg2 },
    { id: 3, delay: '0.3s', title: 'Gastroenterology & Hepatology', description: 'Dr. Sandeep Menon', iconClass: 'fa-solid fa-bacterium', svg2: SVGICONS.iconbg3 },
    { id: 4, delay: '0.4s', title: 'Gastroenterology', description: 'Dr. Sameer Sakkeer Hussain, Dr. Sandeep Menon', iconClass: 'fa-solid fa-microscope', svg2: SVGICONS.iconbg6 },
    { id: 5, delay: '0.5s', title: 'General Medicine', description: 'Dr. Iyad Muhammad P', iconClass: 'fa-solid fa-stethoscope', svg2: SVGICONS.iconbg2 },
    { id: 6, delay: '0.6s', title: 'General Practitioner', description: 'Dr. Shalija M', iconClass: 'fa-solid fa-user-doctor', svg2: SVGICONS.iconbg5 },
    { id: 7, delay: '0.7s', title: 'Gynecology', description: 'Dr. Indira', iconClass: 'fa-solid fa-venus', svg2: SVGICONS.iconbg8 },
    { id: 8, delay: '0.8s', title: 'Infertility Medicine', description: 'Dr. Iyad Muhammad P', iconClass: 'fa-solid fa-seedling', svg2: SVGICONS.iconbg5 },
    { id: 9, delay: '0.1s', title: 'Laparoscopic Surgery', description: 'Dr. Muhammed Shameem', iconClass: 'fa-solid fa-scissors', svg2: SVGICONS.iconbg8 },
    { id: 10, delay: '0.2s', title: 'Laparoscopic', description: 'Dr. Muhammed Shameem', iconClass: 'fa-solid fa-circle-nodes', svg2: SVGICONS.iconbg1 },
    { id: 11, delay: '0.3s', title: 'Nephrology', description: 'Dr. Jayameena', iconClass: 'fa-solid fa-droplet', svg2: SVGICONS.iconbg3 },
    { id: 12, delay: '0.4s', title: 'Oncology', description: 'Dr. Rifayi V', iconClass: 'fa-solid fa-ribbon', svg2: SVGICONS.iconbg1 },
    { id: 13, delay: '0.5s', title: 'Ophthalmology', description: 'Dr. Jazeel K, Dr. Najwa PT', iconClass: 'fa-solid fa-eye', svg2: SVGICONS.iconbg1 },
    { id: 14, delay: '0.6s', title: 'Orthopedics', description: 'Dr. Sunil Lal K', iconClass: 'fa-solid fa-bone', svg2: SVGICONS.iconbg2 },
    { id: 15, delay: '0.7s', title: 'Pediatrics', description: 'Dr. Sudha Krishnanunni, Dr. Hasna Jasmine A K, Dr. Abdul Rauf KK', iconClass: 'fa-solid fa-baby', svg2: SVGICONS.iconbg6 },
    { id: 16, delay: '0.8s', title: 'Psychiatry', description: 'Psychiatry Department', iconClass: 'fa-solid fa-brain', svg2: SVGICONS.iconbg4 },
    { id: 17, delay: '0.1s', title: 'Rheumatology', description: 'Dr. Chandhu A S', iconClass: 'fa-solid fa-hand', svg2: SVGICONS.iconbg7 },
    { id: 18, delay: '0.2s', title: 'Spine Surgery', description: 'Dr. Jipin Gopi', iconClass: 'fa-solid fa-person-cane', svg2: SVGICONS.iconbg3 },
    { id: 19, delay: '0.3s', title: 'Sports Medicine', description: 'Dr. Abrar Hassan', iconClass: 'fa-solid fa-person-running', svg2: SVGICONS.iconbg4 },
    { id: 20, delay: '0.4s', title: 'Urology', description: 'Dr. Jithin Lal M', iconClass: 'fa-solid fa-mars', svg2: SVGICONS.iconbg7 },
]
// sidebar 
